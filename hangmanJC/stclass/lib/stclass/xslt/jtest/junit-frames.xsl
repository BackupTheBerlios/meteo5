...
<xsl:template match="testsuite" mode="class.details">
    ...
    <xsl:variable name="class.name"><xsl:if test="not($package.name = '')"><xsl:value-of select="$package.name"/>.</xsl:if><xsl:value-of select="@classname"/></xsl:variable>
    <html>
        <head>
  ...
  <xsl:template match="properties">
    cur = TestSuite['<xsl:value-of select="../../@package"/>.<xsl:value-of select="../../@classname"/>'] = new Array();
    ...
    <html>
        ...
        <body>
            ...
            <table width="100%">
                    ...
                    <tr>
                        <td nowrap="nowrap">
                            <a href="{@classname}.html" target="classFrame"><xsl:value-of select="@classname"/></a>
                        </td>
                    </tr>
                </xsl:for-each>
            </table>
        ...
        <td nowrap="nowrap">
            <a target="classFrame">
                <xsl:attribute name="href">
                    ...
                    </xsl:if><xsl:value-of select="@classname"/><xsl:text>.html</xsl:text>
                </xsl:attribute>
...
<xsl:template match="testsuite" mode="print.test">
    <tr valign="top">
        ...
        <td><a href="{@classname}.html"><xsl:value-of select="@classname"/></a></td>
