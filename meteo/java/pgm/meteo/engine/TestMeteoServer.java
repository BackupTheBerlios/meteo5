...
public class TestMeteoServer extends MeteoServer{
	...
	/**
	 * Renvoi un metar selon le code de l'aéroport.
	 * Comme il s'agit d'un serveur de test, les metars
	 * renvoyés viennent d'un fichier.
	 * @param code Code de l'aéroport recherché. 
	 * @param timeStamp Heure de la meusure.
	...
	public String getAMetarString(String code, long timeStamp){
		...
		try {
			...
			// Parcours du fichier à la recherche du metar
			// correspondant au code de l'avion.
			String line = "";
