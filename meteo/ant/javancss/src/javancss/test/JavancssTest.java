 ...
 *
 *   $Id: JavancssTest.java,v 1.1 2006/10/07 15:28:40 meteo Exp $
 *   3. 9. 1996
 */
                          ...
                          implements JavancssConstants 
{
	...
	if ( !bSkip ) {
        ...
        pJavancss = new Javancss(asArg, "$Header: /home/xubuntu/berlios_backup/github/tmp-cvs/meteo5/Repository/meteo/ant/javancss/src/javancss/test/Attic/JavancssTest.java,v 1.1 2006/10/07 15:28:40 meteo Exp $");
