...
public class JavancssAntTask extends MatchingTask {
    ...
    private int generateReport(Vector fileList) {
        ...
        log("Executing: javancss " + Util.objectsToVector(javancssArguments)
            , Project.MSG_VERBOSE);
        Javancss javancss = new Javancss(javancssArguments, "$Header: /home/xubuntu/berlios_backup/github/tmp-cvs/meteo5/Repository/meteo/ant/javancss/src/javancss/Attic/JavancssAntTask.java,v 1.1 2006/10/07 15:28:40 meteo Exp $");
